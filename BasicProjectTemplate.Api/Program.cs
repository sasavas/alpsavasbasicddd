...
using BasicProjectTemplate.Api.DependencyConfigurations;
using BasicProjectTemplate.Api.MiddleWares;
using BasicProjectTemplate.Api.Utils;
using BasicProjectTemplate.Application;
...
namespace BasicProjectTemplate.Api
{

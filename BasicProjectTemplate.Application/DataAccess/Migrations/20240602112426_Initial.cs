...
namespace BasicProjectTemplate.Application.Migrations
{
    /// <inheritdoc />
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("pk_password_reset_values", x => new { x.user_id, x.id });
                    table.ForeignKey(
                        name: "fk_password_reset_values_users_user_id",
                        column: x => x.user_id,
